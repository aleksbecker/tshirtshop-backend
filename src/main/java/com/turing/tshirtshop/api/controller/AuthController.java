...
import com.turing.tshirtshop.api.payload.ApiResponse;
import com.turing.tshirtshop.api.payload.JwtAuthenticationResponse;
import com.turing.tshirtshop.api.payload.LoginRequest;
import com.turing.tshirtshop.api.payload.SignUpRequest;
import com.turing.tshirtshop.api.repository.RoleRepository;
import com.turing.tshirtshop.api.repository.UserRepository;
import com.turing.tshirtshop.api.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        Role userRole = roleRepository.findByName(RoleName.getRoleName(signUpRequest.getRole()))
